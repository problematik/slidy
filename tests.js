(function(){
	...
	testGroup("Testiramo MoveableSlider", function(){
		...
		var vrnil = MoveableSlider.prototype.nastaviValueZnotrajRange.call(a, -20);
		assertThat(vrnil === 0, "Znotraj range ne pusti vrednosti pod 0");
		var vrnil = MoveableSlider.prototype.nastaviValueZnotrajRange.call(a, 20);
		assertThat(vrnil === 20, "Znotraj pravilno oceni vrednosti znotraj range");
		var vrnil = MoveableSlider.prototype.nastaviValueZnotrajRange.call(a, 60);
		assertThat(vrnil === 40, "Znotraj range ne pusti vrednosti nad max");

		var preracunano = MoveableSlider.prototype.preracunaj.call(a, -1);
		assertThat(preracunano == 0, "Preracunaj pravilno odsteva");
		var preracunano = MoveableSlider.prototype.preracunaj.call(a, 1);
		assertThat(preracunano == 40, "Preracunaj pravilno sešteva");
		...
		// 	range: 40
		// };
		// function znotrajRange(smer){
		// 	vrnil = MoveableSlider.prototype.znotrajRange.call(a, smer);
		// 	if(vrnil !== false) {
		// 		a.data.kot = vrnil;
		// 	}
		// }
		...
		// znotrajRange(-1);
		// assertThat(a.data.kot === 0 && vrnil === 0, "Preracunaj pravilno zmanjsal kot");

		// znotrajRange(-1)
		// assertThat(a.data.kot === 0 && vrnil === false, "Preracunaj ni postavil kota pod min");

		// znotrajRange(1);
		// znotrajRange(1);
		// znotrajRange(1);
		// assertThat(a.data.kot === 40 && vrnil === false, "Preracunaj ni postavil kota nad max");
	});
})();
